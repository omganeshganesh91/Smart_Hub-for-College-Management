                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper style={{ width: '260px', borderRadius: '18px', backgroundImage: ' linear-gradient(to right, #434343 0%, black 100%)', color: 'white' }}>
                            ...
                            <div style={{ fontSize: '18px', marginBottom: '10px', color: '#333', marginTop: '58px', color: 'white' }}>
                                    <strong style={{ color: 'white' }}>HELLO TEACHER,</strong> {currentUser.name} 
                                </div>
                            </Title>
                    ...
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper style={{ width: '260px', borderRadius: '18px', backgroundImage: ' linear-gradient(to right, #434343 0%, black 100%)', color: 'white' }}>
                            ...
                            <Title>
                            <div style={{ fontSize: '18px', marginBottom: '10px', color: '#333', marginTop: '58px', color: 'white' }}>
                                    <strong style={{ color: 'white' }}>YOUR SUBJECT IS,</strong> {teachSubject.subName}
                                </div>
                            </Title>
                    ...
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper style={{ width: '260px', borderRadius: '18px', backgroundImage: ' linear-gradient(to right, #434343 0%, black 100%)', color: 'white' }}>
                            ...
                            <Title>
                            <div style={{ fontSize: '18px', marginBottom: '10px', color: '#333', marginTop: '58px', color: 'white' }}>
                                    <strong style={{ color: 'white' }}>Total Sessions,</strong> you have
                                </div>
                            </Title>
